class ControllaUguaglianza{
  /*public static void main(String[] args) {
    Persona personaA = new Persona("Mario", "Rossi");
    Persona personaB = new Persona("Luigi", "Verdi");
    Persona personaC = new Persona("Mario", "Rossi");
    Object oggetto = new Object();
    System.out.println(personaA.equals(personaB));
    System.out.println(personaA.equals(oggetto));
    System.out.println(personaA.equals(personaC));
  }*/
  public static void main(String[] args) {
